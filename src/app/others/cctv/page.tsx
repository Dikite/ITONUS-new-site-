...
const SecuritySurveillancePage: React.FC = () => {
  ...
  const features = [
    ...
    const Partners = [
       ...
       { name: 'Matrix', image: '/serviceslogo/cctv/matrix.png' },
        { name: 'Hikvision', image: '/serviceslogo/cctv/hikvision.png' },
         { name: 'cpplus', image: '/serviceslogo/cctv/cpplus.png' },
          { name: 'Honeywell', image: '/serviceslogo/cctv/Honeywell.png' },
        ...
        <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 1 }}>
          <Grid container spacing={4} alignItems="center">
            <Grid size={{ xs: 12, md: 6 }}>
              ...
              <Typography variant="h6" sx={{ mb: 4, color: 'white', lineHeight: 1.6  }}>
        ...
        <Grid container spacing={6}>
          ...
          <Grid size={{ xs: 12, lg: 8 }}>
            ...
            <Box sx={{ mb: 6 }}>
              ...
              We provide reliable and flexible CCTV solutions that help you monitor your premises in real time,
  improve safety, and protect valuable assets. Our systems are easy to manage, scalable for future
  requirements, and backed by dedicated technical support.
              </Typography>
