...
const SecurityAccessPage: React.FC = () => {
  ...
  const features = [
    'Access Control Office Entrance',
  ...
  const Vendors = [
    {
      name: "Honeywell",
      image: "/serviceslogo/Accesssecuritysystems/Honeywell.png"
    },
    {
      name: "Panasonic_logo",
      image: "/serviceslogo/Accesssecuritysystems/Panasonic_logo.png"
    },
      {
      name: "Matrix",
      image: "/serviceslogo/Accesssecuritysystems/matrix.png"
    },
  ];
