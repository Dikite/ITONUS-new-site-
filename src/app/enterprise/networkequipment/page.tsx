...
const NetworkEquipmentPage: React.FC = () => {
 ...
 const vendors = [
  {
    name: "Forthinet",
    image: "/serviceslogo/NetworkEquipment&Infrastructure/Fortinet_logo.png"
  },
  {
    name: "Palo Alto",
    image: "/serviceslogo/NetworkEquipment&Infrastructure/PaloAlto.png"
  },
  {
    name: "Comstor",
    image: "/serviceslogo/NetworkEquipment&Infrastructure/comstor.png"
  },
  {
    name: "Juniper",
    image: "/serviceslogo/NetworkEquipment&Infrastructure/Juniper.png"
  },
  {
    name: "Levelone",
    image: "/serviceslogo/NetworkEquipment&Infrastructure/levelone.png"
  },
  {
    name: "LinkSys",
    image: "/serviceslogo/NetworkEquipment&Infrastructure/linksys_logo.png"
  },
  {
    name: "Netgear",
    image: "/serviceslogo/NetworkEquipment&Infrastructure/Netgear_logo.png"
  },
  {
    name: "Tipping Point",
    image: "/serviceslogo/NetworkEquipment&Infrastructure/tipping_point.png"
  },
  {
    name: "Cisco System",
    image: "/serviceslogo/NetworkEquipment&Infrastructure/Cisco_Systems.png"
  },
                  ...
                  {capabilities.map((capability, index) => (
                    <Grid size={{ xs: 12, sm: 6 }} key={index}>
                      <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 ,color:'white'}}>
                        ...
                        />
                        <Typography variant="body1" sx={{ fontWeight: 500, fontSize: '1.1rem',color:'white' }}>
                          {capability}
                        </Typography>
                      </Box>
                    </Grid>
