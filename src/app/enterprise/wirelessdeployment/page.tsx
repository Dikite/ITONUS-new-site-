...
const WirelessDeploymentPage: React.FC = () => {
 ...
 const vendors = [
  {
    name: "Cisco Systems",
    image: "/serviceslogo/WirelessDeployment&NetworkSolutions/CiscoSystems.png"
  },
  {
    name: "Aruba Networks",
    image: "/serviceslogo/WirelessDeployment&NetworkSolutions/arubologo.png"
  },
  {
    name: "Colubris",
    image: "/serviceslogo/WirelessDeployment&NetworkSolutions/Colubris.png"
  },
  {
    name: "Belden",
    image: "/serviceslogo/WirelessDeployment&NetworkSolutions/BeldenLogo.png"
  },
  {
    name: "LevelONE",
    image: "/serviceslogo/WirelessDeployment&NetworkSolutions/levelone.png"
  },
  {
    name: "Netgear",
    image: "/serviceslogo/WirelessDeployment&NetworkSolutions/Netgear.png"
  },
          ...
          <Grid size={{ xs: 12, lg: 8 }}>
                ...
                <Grid container spacing={2}>
                  {benefits.map((benefit, index) => (
                    <Grid size={{ xs: 12, sm: 6 }} key={index}>
                      <Box sx={{ display: 'flex', alignItems: 'flex-start', mb: 2  , color:'white'}}>
                        <CheckCircle
                          sx={{
            ...
            <Box sx={{ mb: 6 }}>
              <Typography variant="h4" gutterBottom sx={{ fontWeight: 600, mb: 3 , color:'white' }}>
                ...
                <Typography variant="h6" paragraph sx={{ textAlign: 'center', mb: 4, color:'white' }}>
